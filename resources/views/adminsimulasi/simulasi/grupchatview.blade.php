                ...
                <table id="datatables" class="table table-striped datatables">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ route('adminsimulasi.simulasi.kelola.grupchat.member.kick', ['id' => $simulasi->id, 'idMember' => $w->id]) }}" class="btn btn-xs btn-danger delete btn-icon"><i class="mdi mdi-delete"></i> keluarkan dari grub</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
