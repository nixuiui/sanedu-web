...
<div class="row">
    <div class="col-md-6">
        <form class="panel panel-default" action="{{ route('adminsimulasi.simulasi.kelola.peserta.edit.profil', ['id' => $simulasi->id, 'idPeserta' => $user->id]) }}" method="post">
    ...
    <div class="col-md-6">
        <form class="panel panel-default" action="{{ route('adminsimulasi.simulasi.kelola.peserta.edit.email', ['id' => $simulasi->id, 'idPeserta' => $user->id]) }}" method="post">
        ...
        <form class="panel panel-default" action="{{ route('adminsimulasi.simulasi.kelola.peserta.edit.username', ['id' => $simulasi->id, 'idPeserta' => $user->id]) }}" method="post">
        ...
        <form class="panel panel-default" action="{{ route('adminsimulasi.simulasi.kelola.peserta.edit.password', ['id' => $simulasi->id, 'idPeserta' => $user->id]) }}" method="post">
