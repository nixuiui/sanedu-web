...
class ProfilController extends Controller {
    ...
    public function editProfil(Request $data, $id, $idPeserta) {
    ...
    public function editEmail(Request $data, $id, $idPeserta) {
        $this->validate($data, [
    ...
    public function editUsername(Request $data, $id, $idPeserta) {
        $this->validate($data, [
    ...
    public function editPassword(Request $data, $id, $idPeserta) {
        $this->validate($data, [
